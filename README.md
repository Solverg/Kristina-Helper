...
- Показывает индикатор безопасности процесса (🛡️ verified / ⚠️ dangerous / ❔ unknown).
...
- `descriptions.json` — локальный кэш AI-описаний процессов в формате:
  `{"process.exe": {"description": "...", "status": "verified|dangerous|unknown"}}`
